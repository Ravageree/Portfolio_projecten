        ...
        <section id="section">
            ...
            <div class="content">
                ...
                <section>
                    <h1>De Developers</h1>
                    <ul class="about_list">
                        <li class="about">Thomas: Develop the database and did make the Slot Machine.</li>
                        <li class="about">Kevin: Supporting the database and lead the groep and did make the Hangman.</li>
                        <li class="about">Silvano: Developing the CSS and largely the HTML and did make Cookie Clicker.</li>
