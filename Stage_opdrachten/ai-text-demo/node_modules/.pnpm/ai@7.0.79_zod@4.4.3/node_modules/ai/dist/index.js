...
// src/version.ts
var VERSION = true ? "7.0.79" : "0.0.0-test";
...
async function generateText({
  ...
  const executeGenerateText = async () => {
    ...
    try {
          ...
          await runInTracingChannelSpan({
            ...
            execute: async () => {
              ...
              currentModelResponse = await retry(async () => {
                ...
                const responseData = {
                  id: (_b3 = (_a26 = result.response) == null ? void 0 : _a26.id) != null ? _b3 : generateId4(),
      ...
      let resolvedOutput;
      if (lastStep.finishReason === "stop" || lastStep.finishReason == null && lastStep.text.length > 0) {
        ...
        try {
          ...
          self.addStream(
            streamWithToolResults.pipeThrough(
              new TransformStream({
                async transform(chunk, controller) {
                  var _a25, _b2, _c2, _d2, _e2, _f2, _g2;
                  ...
                  switch (chunkType) {
                    ...
                    case "text-delta": {
                      if (chunk.text.length > 0 || chunk.providerMetadata != null) {
                        controller.enqueue({
                          ...chunk,
                          id: (_a25 = textPartIds.get(chunk.id)) != null ? _a25 : chunk.id
                        });
                      }
                      break;
                    }
...
async function generateObject(options) {
  ...
  try {
    ...
    const responseData = {
      id: (_b = (_a23 = generateResult.response) == null ? void 0 : _a23.id) != null ? _b : generateId4(),
...
async function experimental_generateVideo({
  ...
  const maxVideosPerCallWithDefault = (_a23 = maxVideosPerCall != null ? maxVideosPerCall : await invokeModelMaxVideosPerCall(model)) != null ? _a23 : 1;
