...
packages:
  ...
  '@ai-sdk/google@4.0.51':
    resolution: {integrity: sha512-VAVXFtmMwrMDWgWzONew3yBFuE+ktfPJQn554+bOgUspNSMqIAm6PJRU6Mdd4M+4xCUAJi5H5tVtFF0+Je+Eog==}
    engines: {node: '>=22'}
    peerDependencies:
      zod: ^3.25.76 || ^4.1.8
...
snapshots:
  ...
  '@ai-sdk/google@4.0.51(zod@4.4.3)':
    dependencies:
      '@ai-sdk/provider': 4.0.8
      '@ai-sdk/provider-utils': 5.0.30(zod@4.4.3)
      zod: 4.4.3
